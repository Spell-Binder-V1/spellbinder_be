  ...
  describe "#class methods" do
    ...
    describe "#get_card_search" do
      it "returns a card search", :vcr do
        ...
        expect(search[:cards].first).to have_key(:colors)
        expect(search[:cards].first[:colors]).to be_a(Array).or be_a(String).or be(nil)
        expect(search[:cards].first).to have_key(:colorIdentity)
        expect(search[:cards].first[:colorIdentity]).to be_a(Array).or be(nil)
        ...
        expect(search[:cards].first).to have_key(:subtypes)
        expect(search[:cards].first[:subtypes]).to be_a(Array).or be(nil)
        ...
        expect(search[:cards].first).to have_key(:power)
        expect(search[:cards].first[:power]).to be_a(String).or be(nil)
        expect(search[:cards].first).to have_key(:toughness)
        expect(search[:cards].first[:toughness]).to be_a(String).or be(nil)
